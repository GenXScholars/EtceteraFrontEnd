jQuery(window).on('load',function() {
	...
	"<div class='switcher'>"+
		"<div class='switcherWrappper'>"+
			...
			"<button class='switcherShowHide'><i class='ti-settings'></i></button>"+
			"<div class='switcherContents'>"+
				...
				"<div class='switcherContent skinsColor'>"+
					...
					"<li data-name='gnrl_color' data-value='yellow' data-value-2='f8ba01' style='background-image: linear-gradient(to top, #f77062 0%, #fe5196 100%);'></li>"+
					"<li data-name='gnrl_color' data-value='pink' data-value-2='ff6b6b' style='background-image:  linear-gradient( 89.5deg,  #5558da 0.2%, #5558da 90.6% );'></li>"+
					"<li data-name='gnrl_color' data-value='blue' data-value-2='3498db' style=' background: linear-gradient( 89.5deg,  #f67280 0.2%, #f67280 90.6% )'></li>"+
